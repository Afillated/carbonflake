...
QtObject {
    ...
    readonly property color transground: "#33{{background | strip}}"
    readonly property color transground2: "#66{{background | strip}}"
    readonly property color transground3: "#AA{{background | strip}}"
